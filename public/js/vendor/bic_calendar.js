  ...
  this.each(function() {
    var elem = $(this);
      ...
      function showCalendar() {
        ...
        var nextMonthButton = $('<td class="month-and-year"><a href="#" class="button-month-next">&gt;&gt;</a></td>');
        //event
        ...
        var previousMonthButton = $('<td class="month-and-year"><a href="#" class="button-month-previous">&lt;&lt;</a></td>');
        //event
        ...
        var nextYearButton = $('<td class="month-and-year"><a href="#" class="button-year-next">&gt;&gt;</a></td>');
        //event
        ...
        var previousYearButton = $('<td class="month-and-year"><a href="#" class="button-year-previous">&lt;&lt;</a></td>');
        //event
        ...
        if (displayYearController === true) {
          var yearTextLayer = $('<tr class="year-text-layer"></tr>');
          var yearControlTextLayer = $('<td colspan=5 class="month-and-year span6"></td>');
        ...
        if (displayMonthController === true) {
          ...
          var monthControlTextLayer = $('<td colspan=5 class="month-and-year span6"></td>');
      ...
      function showMonthDays(month, year) {
        ...
        for (var i = 0; i < 7; i++) {
          if (i < firstDay) {
            ...
            if (i == 0)
              dayCode += "<tr>";
            //add weekDay
            dayCode += '<td class="leper-day invalid-day week-day-' + i + '"';
            dayCode += '"></td>';
          } else {
            var dayCode = "";
            if (i == 0)
            ...
            //add weekDay
            dayCode += ' class="leper-day day week-day-' + i + '"';
        ...
        while (daysCounter <= lastDayMonth) {
          ...
          dayCode += '<td id="' + calendarId + '_' + daysCounter + "_" + nMonth + "_" + year + '" data-date="' + nMonth + "/" + daysCounter + "/" + year + '" ';
          //add weekDay
          dayCode += ' class="leper-day day week-day-' + ((currentWeekDay - 1) % 7) + '"';
        ...
        if (currentWeekDay % 7 != 0) {
          ...
          for (var i = (currentWeekDay % 7) + 1; i <= 7; i++) {
            ...
            dayCode += '<td ';
            //add weekDay
            dayCode += ' class="leper-day invalid-day week-day-' + (i - 1) + '"';
            dayCode += '"></td>';
            if (i == 7)
              dayCode += '</tr>'
            daysMonthLayerString += dayCode
